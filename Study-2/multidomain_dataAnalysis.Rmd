...
```
M4 - acoDistance + F2_Slope + kinDistance + TB_Speed
```{r}
# Building the model
...
```
M5 - acoDistance*Sex + F2_Slope*Sex + kinDistance*Sex + TB_Speed*Sex
```{r}
# Building the model
...
base::saveRDS(Int_ai_m7, file = "Models/Int_ai_m7.rds")
```
