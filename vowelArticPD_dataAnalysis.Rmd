...
plot_Int <- rio::import(file = "Data/PreppedData/ListenerData/ListenerRatings_allRatings.csv") %>%
  ...
  ggsignif::geom_signif(
    y_position = c(100, 100, 100, NA, NA, NA),
    xmin = c(.8, 1.8, 2.8, NA, NA, NA),
    xmax = c(1.2, 2.2, 3.2, NA, NA, NA),
    annotation = c("*", "*", "*", NA, NA, NA),
    tip_length = 0,
    color = "black",
  ) +
...
plot_Int <- plotData %>%
  ...
  coord_cartesian(
    ylim = c(0,
             (base::max(plot_Int_data$upper) + base::max(plot_Int_data$upper)*.45))) +
  scale_y_continuous(breaks=c(0, 25, 50, 75, 100)) +
...
plot_AP <- plot_AP_data %>%
  ...
  coord_cartesian(
    ylim = c(0,
             (base::max(plot_AP_data$upper) + base::max(plot_AP_data$upper)*.45))) +
  scale_y_continuous(breaks=c(0, 25, 50, 75, 100)) +
...
plot_acoDistance_data <- rio::import(file = "Data/PreppedData/CollatedData/TargetMeasures_aiMeasures.csv") %>%
  ...
  # Making the Plot
plot_acoDistance <- plot_acoDistance_data %>%
  ggplot() +
  aes(y = acoDistance,
      x = condition) +
  geom_boxplot(aes(
  ...
  ggsignif::geom_signif(data = data.frame(Group = c(
    ...
    "Conv",
    "More\nClear")),
    aes(y_position = c(1850, 1850, 1850, 1850, 1850, 1850),
        xmin = c(
          # Male Speakers
          0.8, # Less Clear -> Conv
          1.9, # Conv -> More Clear
  ...
  ggsignif::geom_signif(data = data.frame(Group = c(
    ...
    "Conv",
    "More\nClear")),
    aes(y_position = c(2050, 2050, 2050, 2050, 2050, 2050),
        xmin = c(
          # Male Speakers
          1.2, # Less Clear -> Conv
          2.3, # Conv -> More Clear
...
plot_F2_Slope_data <- rio::import(file = "Data/PreppedData/CollatedData/TargetMeasures_aiMeasures.csv") %>%
  ...
  # Making the Plot
plot_F2_Slope <- plot_F2_Slope_data %>%
  ggplot() +
  aes(y = F2_Slope,
      x = condition) +
  geom_boxplot(aes(
  ...
  ggsignif::geom_signif(data = data.frame(Group = c(
    ...
    "Conv",
    "More\nClear")),
    aes(y_position = c(11, 11, 11, 11, 11, 11),
        xmin = c(
          # Male Speakers
          0.8, # Less Clear -> Conv
          1.9, # Conv -> More Clear
  ...
  ggsignif::geom_signif(data = data.frame(Group = c(
    ...
    "Conv",
    "More\nClear")),
    aes(y_position = c(13, 13, 13, 13, 13, 13),
        xmin = c(
          # Male Speakers
          1.2, # Less Clear -> Conv
          2.3, # Conv -> More Clear
...
plot_kinDistance_data <- rio::import(file = "Data/PreppedData/CollatedData/TargetMeasures_aiMeasures.csv") %>%
  ...
  # Making the Plot
plot_kinDistance <- plot_kinDistance_data %>%
  ggplot() +
  aes(y = kinDistance,
      x = condition) +
  geom_boxplot(aes(
  ...
  ggsignif::geom_signif(data = data.frame(Group = c(
    ...
    "Conv",
    "More\nClear")),
    aes(y_position = c(30, 30, 30, 30, 30, 30),
        xmin = c(
          # Male Speakers
          0.8, # Less Clear -> Conv
          1.9, # Conv -> More Clear
  ...
  ggsignif::geom_signif(data = data.frame(Group = c(
    ...
    "Conv",
    "More\nClear")),
    aes(y_position = c(33, 33, 33, 33, 33, 33),
        xmin = c(
          # Male Speakers
          1.2, # Less Clear -> Conv
          2.3, # Conv -> More Clear
...
## 8. dTB Speed
```{r}
plot_dTB_Speed_data <- rio::import(file = "Data/PreppedData/CollatedData/TargetMeasures_aiMeasures.csv") %>%
  dplyr::mutate(Sex = factor(Sex,
                             levels = c("M",
                                        "F"),
                             labels = c("Male Speakers",
  ...
  # Making the Plot
plot_dTB_Speed <- plot_dTB_Speed_data %>%
  ggplot() +
  aes(y = dTB_speedMax,
      x = condition) +
  geom_boxplot(aes(
  ...
  ggsignif::geom_signif(data = data.frame(Group = c(
    ...
    "Conv",
    "More\nClear")),
    aes(y_position = c(800, 800, 800, 800, 800, 800),
        xmin = c(
          # Male Speakers
          0.8, # Less Clear -> Conv
          1.9, # Conv -> More Clear
...
## 8. Jaw Speed
```{r}
plot_Jaw_Speed_data <- rio::import(file = "Data/PreppedData/CollatedData/TargetMeasures_aiMeasures.csv") %>%
  dplyr::mutate(Sex = factor(Sex,
                             levels = c("M",
                                        "F"),
                             labels = c("Male Speakers",
  ...
  # Making the Plot
plot_Jaw_Speed <- plot_Jaw_Speed_data %>%
  ggplot() +
  aes(y = Jaw_speedMax,
      x = condition) +
  geom_boxplot(aes(
  ...
  ggsignif::geom_signif(data = data.frame(Group = c(
    ...
    "Conv",
    "More\nClear")),
    aes(y_position = c(500, 500, 500, 500, 500, 500),
        xmin = c(
          # Male Speakers
          0.8, # Less Clear -> Conv
          1.9, # Conv -> More Clear
